...
const embed3 = new RichEmbed()
  ...
  .setThumbnail(
    "https://static-cdn.jtvnw.net/jtv_user_pictures/96581880-013b-43e6-8510-05b53b2531d1-profile_image-70x70.jpg"
  );
const embed4 = new RichEmbed()
  ...
  .setColor(0xff0000)
  .setDescription(
    "Kitty, 30+, tea-fueled, non-binary / genderqueer [they/them or she/her], disabled / autistic [please be patient when conversing with me. my brain's RAM is faulty. :P], Engaged, a thirsty cowboy fucker"
  )
  .setURL("https://twitch.tv/hashtaghealer")
  .setThumbnail(
    "https://static-cdn.jtvnw.net/jtv_user_pictures/169a5482-6bb4-42a5-b55a-8b263aba30c5-profile_image-70x70.png"
  );
const embed5 = new RichEmbed()
  ...
  .setColor(0xff0000)
  .setDescription(
    "I currently am Chemistry PhD student in my last year of study looking to take a break from the daily grind by streaming games I enjoy and playing with some friends along the way."
  )
  .setURL("https://twitch.tv/orchios")
  .setThumbnail(
    "https://static-cdn.jtvnw.net/jtv_user_pictures/382aace9-3139-49e7-8997-f76a1f384bb0-profile_image-70x70.png"
  );
module.exports = {
  name: "socials",
  description: "Displays the social media information of a stream team member.",
  guildOnly: true,
  args: true,
  execute(message, args) {
    if (args[0] === "NekomancerTV") {
      return message.channel.send(embed);
    } else if (args[0] === "Reynic") {
      return message.channel.send(embed2);
    } else if (args[0] === "Layrenna") {
      return message.channel.send(embed3);
    } else if (args[0] === "Kitty") {
      return message.channel.send(embed4);
    } else if (args[0] === "Orchios") {
